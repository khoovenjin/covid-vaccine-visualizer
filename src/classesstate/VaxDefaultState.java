...
public class VaxDefaultState<T,U> extends VaxState<T,U> {

//	public Nullable<String> state = new Nullable<String>("Malaysia");
	{
		state.setData("Malaysia");
	}
	
	public VaxDefaultState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
