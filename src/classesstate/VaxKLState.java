...
public class VaxKLState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("W.P. Kuala Lumpur");
	{
		state.setData("W.P. Kuala Lumpur");
	}
	
	public VaxKLState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
