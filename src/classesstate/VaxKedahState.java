...
public class VaxKedahState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Kedah");
	{
		state.setData("Kedah");
	}
	
	public VaxKedahState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
