...
public class VaxKelantanState<T,U> extends VaxState<T,U> {

//	public Nullable<String> state = new Nullable<String>("Kelantan");
	{
		state.setData("Kelantan");
	}
	
	public VaxKelantanState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
