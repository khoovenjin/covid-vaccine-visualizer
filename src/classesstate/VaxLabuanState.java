...
public class VaxLabuanState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("W.P. Labuan");
	{
		state.setData("W.P. Labuan");
	}
	
	public VaxLabuanState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
