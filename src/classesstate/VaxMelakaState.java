...
public class VaxMelakaState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Melaka");
	{
		state.setData("Melaka");
	}
	
	public VaxMelakaState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
