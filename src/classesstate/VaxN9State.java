...
public class VaxN9State<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Negeri Sembilan");
	{
		state.setData("Negeri Sembilan");
	}
	
	public VaxN9State(T date, U daily_partial, U daily_full, U daily_booster, U daily,
