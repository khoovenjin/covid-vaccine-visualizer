...
public class VaxPahangState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Pahang");
	{
		state.setData("Pahang");
	}
	
	public VaxPahangState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
