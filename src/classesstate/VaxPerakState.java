...
public class VaxPerakState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Perak");
	{
		state.setData("Perak");
	}
	
	public VaxPerakState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
