...
public class VaxPerlisState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Perlis");
	{
		state.setData("Perlis");
	}
	
	public VaxPerlisState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
