...
public class VaxPinangState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Pulau Pinang");
	{
		state.setData("Pulau Pinang");
	}
	
	public VaxPinangState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
