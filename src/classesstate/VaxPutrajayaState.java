...
public class VaxPutrajayaState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("W.P. Putrajaya");
	{
		state.setData("W.P. Putrajaya");
	}
	
	public VaxPutrajayaState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
