...
public class VaxSabahState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Sabah");
	{
		state.setData("Sabah");
	}
	
	public VaxSabahState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
