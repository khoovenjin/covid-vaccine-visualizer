...
public class VaxSarawakState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Sarawak");
	{
		state.setData("Sarawak");
	}
	
	public VaxSarawakState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
