...
public class VaxSelangorState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Selangor");
	{
		state.setData("Selangor");
	}
	
	public VaxSelangorState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
