...
public class VaxTerengganuState<T,U> extends VaxState<T,U> {
	
//	public Nullable<String> state = new Nullable<String>("Terengganu");
	{
		state.setData("Terengganu");
	}
	
	public VaxTerengganuState(T date, U daily_partial, U daily_full, U daily_booster, U daily,
